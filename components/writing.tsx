...
export async function WritingSection() {
  const { blog, newsletter, research } = await getContent();
  ...
  const index = research.length ? "05" : "04";
  return (
    <section id="writing" className="section">
      <SectionHeading index={index} eyebrow="Writing" title="Engineering notes from systems I actually build." description="No generic tutorial wall: the blog is for architecture decisions, failure modes, evaluation, backend systems, and product lessons." />
