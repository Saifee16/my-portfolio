...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [{ url: base, lastModified: new Date() }, { url: `${base}/experience`, lastModified: new Date() }, { url: `${base}/research`, lastModified: new Date() }, { url: `${base}/now`, lastModified: new Date() }, ...(blogUrls.length ? [{ url: `${base}/blog`, lastModified: new Date() }] : []), ...(content.certifications.length ? [{ url: `${base}/certifications`, lastModified: new Date() }] : []), ...projectUrls, ...blogUrls];
}
