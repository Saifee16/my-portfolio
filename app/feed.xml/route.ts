...
export async function GET() {
  ...
  const xml = `<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>${escapeXml(siteDefaults.name)} — Engineering notes</title><link>${base}/blog</link><description>Engineering notes on applied AI, backend systems, evaluation, and product engineering.</description>${items}</channel></rss>`;
